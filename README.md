...
- The hero wave highlight, points and ambient glow loop continuously while visible, without manual pause/resume controls. Reduced-motion preferences disable animation and offscreen/hidden-tab animations pause automatically.
...
- Automated tests: 25 passed, including language isolation, English admin, translation fields, subscriber deduplication, CSRF, spam rejection, protected media access, complete bilingual legal content, localized feeds, staging indexing protection and control-free hero animation.
